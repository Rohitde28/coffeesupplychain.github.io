    ...
    Ownable
{
    ...
    modifier processed(uint256 _upc) {
        require(items[_upc].itemState == State.Processed, "Not precessed yet.");
        _;
    }
    ...
    function _make_payable(address acc)
        internal
        pure
        ...
        onlyDistributor
    {
        ...
        address payable originFarmerAddress = _make_payable(
            items[_upc].originFarmerID
        );
        originFarmerAddress.transfer(msg.value);
        // emit the appropriate event
        emit Sold(_upc);
    }
